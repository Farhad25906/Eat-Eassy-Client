...
const Meal = () => {
    ...
    return (
        <div>
            <div className='container px-4 py-10 mx-auto min-h-[calc(100vh-306px)] flex flex-col justify-between'>
                <div>
                    {loading && (
                ...
                <div className='flex justify-center mt-12'>
                    ...
                    {pages.map(btnNum => (
                        <button
                            ...
                            key={btnNum}
                            className={`hidden ${currentPage === btnNum ? 'bg-orange-500 text-white' : ''} px-4 py-2 mx-1 transition-colors duration-300 transform rounded-md sm:inline hover:bg-orange-500 hover:text-white`}
                        >
                            {btnNum}
                        </button>
                    ))}
